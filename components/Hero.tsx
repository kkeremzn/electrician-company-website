    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon-orange rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <Zap className="w-20 h-20 md:w-24 md:h-24 text-neon-blue mx-auto" />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <span className="bg-gradient-to-r from-neon-blue via-neon-orange to-neon-blue bg-clip-text text-transparent animate-glow">
            Elektrik Çözümleri
          </span>
        </motion.h1>
